...
int main(){
  ...
  do {
    ...
    // "input"
    // faccao 0 = infec ;1 = imune
    combined[0]  = (grupos) {.n = 1117, .hp = 5042,  .att=boost+44,   .init = 15, .attack_type = fire,        .weak = {1,0,0,0,0}, .immune={0,0,1,1,1}, .faccao=1, .id_enemy = -1};
    combined[1]  = (grupos) {.n = 292,  .hp = 2584,  .att=boost+81,   .init = 18, .attack_type = bludgeoning, .weak = {0,0,0,0,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[2]  = (grupos) {.n = 2299, .hp = 8194,  .att=boost+35,   .init = 7,  .attack_type = radiation,   .weak = {0,0,0,0,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[3]  = (grupos) {.n = 1646, .hp = 6315,  .att=boost+37,   .init = 14, .attack_type = slashing,    .weak = {1,0,0,0,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[4]  = (grupos) {.n = 2313, .hp = 6792,  .att=boost+29,   .init = 9,  .attack_type = bludgeoning, .weak = {0,0,1,1,0}, .immune={0,1,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[5]  = (grupos) {.n = 2045, .hp = 8634,  .att=boost+36,   .init = 13, .attack_type = fire,        .weak = {0,0,0,1,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[6]  = (grupos) {.n = 34,   .hp = 1019,  .att=boost+295,  .init = 6,  .attack_type = cold,        .weak = {0,0,0,0,1}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[7]  = (grupos) {.n = 157,  .hp = 6487,  .att=boost+362,  .init = 3,  .attack_type = radiation,   .weak = {1,1,0,0,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[8]  = (grupos) {.n = 1106, .hp = 4504,  .att=boost+39,   .init = 12, .attack_type = slashing,    .weak = {0,1,0,0,0}, .immune={0,0,0,0,0}, .faccao=1, .id_enemy = -1};
    combined[9]  = (grupos) {.n = 5092, .hp = 8859,  .att=boost+12,   .init = 16, .attack_type = radiation,   .weak = {0,0,0,0,0}, .immune={1,1,0,0,0}, .faccao=1, .id_enemy = -1};
    ...
    while(1){
      ...
      same = !(sum_imune - old_sum_imune) && !(sum_infec - old_sum_infec);
      if(sum_imune <= 0 || sum_infec <= 0 || same) break;
      old_sum_imune = sum_imune;
      old_sum_infec = sum_infec;
